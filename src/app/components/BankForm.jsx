...
return (
    <div className="flex items-center justify-center min-h-screen bg-gray-800 text-white">
      <div className="max-w-md mx-auto mt-8 p-4 rounded shadow-lg bg-gradient-to-r from-blue-500 to-blue-300 text-white">
        <div className="mb-4">
          <h2 className="text-xl font-semibold mb-2">Token Supply: {tokenTotalSupply}</h2>
        </div>
        <form>
          <div className="mb-4">
            <label className="block font-bold mb-2">Transaction Type</label>
            <select
              className="w-full p-2 border border-white rounded focus:outline-none bg-transparent focus:border-yellow-300 text-black"
          ...
          {transactionType === 'transfer' && (
            <div className="mb-4">
              ...
              <input
                name="address"
                className="w-full p-2 border border-white rounded focus:outline-none focus:border-yellow-300 text-black"
